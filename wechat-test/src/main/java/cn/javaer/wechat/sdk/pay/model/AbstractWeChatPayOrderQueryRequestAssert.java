...
public abstract class AbstractWeChatPayOrderQueryRequestAssert<S extends AbstractWeChatPayOrderQueryRequestAssert<S, A>, A extends WeChatPayOrderQueryRequest> extends AbstractObjectAssert<S, A> {
  ...
  /**
   * Verifies that the actual WeChatPayOrderQueryRequest's subAppId is equal to the given one.
   * @param subAppId the given subAppId to compare the actual WeChatPayOrderQueryRequest's subAppId to.
   * @return this assertion object.
   * @throws AssertionError - if the actual WeChatPayOrderQueryRequest's subAppId is not equal to the given one.
   */
  ...
  /**
   * Verifies that the actual WeChatPayOrderQueryRequest's subMchId is equal to the given one.
   * @param subMchId the given subMchId to compare the actual WeChatPayOrderQueryRequest's subMchId to.
   * @return this assertion object.
   * @throws AssertionError - if the actual WeChatPayOrderQueryRequest's subMchId is not equal to the given one.
   */
