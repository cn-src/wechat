...
public class WeChatPayController
{
    ...
    public WeChatPayController(final ApplicationEventPublisher publisher) {this.publisher = publisher;}
    
    //TODO 可配置
    @RequestMapping(path = "notify_result", consumes = MediaType.TEXT_XML_VALUE, produces = MediaType.TEXT_XML_VALUE)
    public NotifyResultReturn notifyResult(@RequestBody final WeChatPayNotifyResult notifyResult)
    {
