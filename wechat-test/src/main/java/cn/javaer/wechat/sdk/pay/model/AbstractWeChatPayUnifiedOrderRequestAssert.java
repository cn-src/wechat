...
public abstract class AbstractWeChatPayUnifiedOrderRequestAssert<S extends AbstractWeChatPayUnifiedOrderRequestAssert<S, A>, A extends WeChatPayUnifiedOrderRequest> extends AbstractObjectAssert<S, A> {
  ...
  /**
   * Verifies that the actual WeChatPayUnifiedOrderRequest's subAppId is equal to the given one.
   * @param subAppId the given subAppId to compare the actual WeChatPayUnifiedOrderRequest's subAppId to.
   * @return this assertion object.
   * @throws AssertionError - if the actual WeChatPayUnifiedOrderRequest's subAppId is not equal to the given one.
   */
  ...
  /**
   * Verifies that the actual WeChatPayUnifiedOrderRequest's subMchId is equal to the given one.
   * @param subMchId the given subMchId to compare the actual WeChatPayUnifiedOrderRequest's subMchId to.
   * @return this assertion object.
   * @throws AssertionError - if the actual WeChatPayUnifiedOrderRequest's subMchId is not equal to the given one.
   */
  ...
  /**
   * Verifies that the actual WeChatPayUnifiedOrderRequest's subOpenid is equal to the given one.
   * @param subOpenid the given subOpenid to compare the actual WeChatPayUnifiedOrderRequest's subOpenid to.
   * @return this assertion object.
   * @throws AssertionError - if the actual WeChatPayUnifiedOrderRequest's subOpenid is not equal to the given one.
   */
